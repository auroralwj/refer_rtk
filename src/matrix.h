...
#if !defined(_NO_EXCEPTION)
//##ModelId=4D5E2F260391
class matrix_error : public logic_error
{
    public:
	//##ModelId=4D5E2F26039A
...
MAT_TEMPLATE
//##ModelId=4D5E2F2603B9
class matrix
{
public:
   // Constructors
	//##ModelId=4D5E2F2603BA
   matrix (const matrixT& m);
	//##ModelId=4D5E2F2603C8
   matrix (size_t row = 6, size_t col = 6);

   // Destructor
	//##ModelId=4D5E2F2603CB
   ~matrix ();
   ...
   // Value extraction method
	//##ModelId=4D5E2F2603CC
   size_t RowNo () const { return _m->Row; }
	//##ModelId=4D5E2F2603D9
...
private:
	//##ModelId=4D5E2F27003E
    struct base_mat
    {
		//##ModelId=4D5E2F27004F
	T **Val;
	size_t Row, Col, RowSiz, ColSiz;
		//##ModelId=4D5E2F270053
	int Refcnt;

		//##ModelId=4D5E2F270054
	...
	//##ModelId=4D5E2F270000
    base_mat *_m;

	//##ModelId=4D5E2F27000F
    void clone ();
	//##ModelId=4D5E2F270010
    void realloc (size_t row, size_t col);
	//##ModelId=4D5E2F27001F
